...
def display_recommendation(courses, final_recommendation, needed_credits, gpa_final, student_major):
    output_string = (
        ...
        "When there are a lot of courses to recommend, recommend up to 4 courses from those listed below by this order of priority:\n"
        "Core Courses\n"
        "Specialization\n"
        "Electives\n"
        "Writing Credit\n"
        ...
        "Note, courses under Culminating Experience should only be recommended if no other courses are listed.\n"
